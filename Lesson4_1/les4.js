...
//Кажется что то из java, так для обьекта приделывали интерфейсы, геттеры, сеттеры. и в итоге получалась
// некая уневирсальность для использования обьекта и хранения в нем информации.
